...
// 1. Create a sub-component that uses useSearchParams()
      ...
      <main>
        <section className="section">
          <div className="container">
            <div className="form" style={{ maxWidth: 700, margin: "auto", textAlign: "center" }}>
              <h1>Booking request received</h1>
              <p className="muted">Your production version will create a booking reference here and take the customer to payment.</p>
            </div>
          </div>
        </section>
      </main>
    ...
    <main>
      <section className="page-head">
        <div className="container">
          ...
          <p>Tell us who is traveling. Payment and confirmation can be connected after Supabase and Paystack are configured.</p>
        </div>
      </section>
      <section className="section">
        <div className="container">
...
export default function BookingPage() {
  return (
    <Suspense fallback={<div style={{ textAlign: "center", padding: "50px" }}>Loading booking page...</div>}>
      <BookingForm />
    </Suspense>
  );
}